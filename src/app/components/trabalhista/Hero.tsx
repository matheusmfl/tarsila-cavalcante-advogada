...
export function Hero() {
  return (
    <main className="py-24 -z-10 px-6 w-full md:py-16 xl:bg-no-repeat xl:px-32 xl:flex xl:items-center xl:justify-center xl:bg-cover bg-hero-trabalhista bg-center">
      {/* Container principal */}
